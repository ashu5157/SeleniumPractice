...
public class TestCaseOrangeHrm {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//add on create 
		SeleniumUtility.driver.findElement(By.cssSelector("button[class='oxd-button oxd-button--medium oxd-button--secondary']")).click();
		//entre name
...
//		//entre on save btn
		...
		Thread.sleep(2000);
		//search on id
		SeleniumUtility.driver.findElement(By.cssSelector(".oxd-form-row>div>*:nth-child(2)>div>*:last-child>input")).sendKeys("0254");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		//
		SeleniumUtility.driver.findElement(By.cssSelector("button[class='oxd-icon-button oxd-table-cell-action-space']>i")).click();
		Thread.sleep(2000);
		//confrim on yes delete btn
		SeleniumUtility.driver.findElement(By.cssSelector("button[class='oxd-button oxd-button--medium oxd-button--label-danger orangehrm-button-margin']")).click();
	}
}
